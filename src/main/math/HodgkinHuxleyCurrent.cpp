...
double ode::hodgkinhuxley::current::isyns(double V, double *arrP, double *arrM, double *arrG,
                                          SynapseConstants *allSynapses,
